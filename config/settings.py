...
SECRET_KEY = '07rp6&=h-q-3dg$s$ho4i-h5_e#s0ywa_^sr@=4!t216huj!3i'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onlineshop',
        'USER': 'root',
        'PASSWORD': '123456789',  # !!! 자신의 비밀번호로 변경
        'HOST': 'localhost',  #
        'PORT': '3306',
        'OPTIONS': {
...
IAMPORT_KEY = '0280909917367246'
IAMPORT_SECRET = '6V8Ef8PfnIjhNeeXWyAGO5loLn2sI71P3atiijyF1RXP5bM2JmIxs4WdrYG96IZ9StsaN0QORODXZq0J'